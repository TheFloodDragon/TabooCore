...
class BlockFadeEvent {
     ...
     * @property level 所在世界
     * @property pos 方块位置
     * @property oldState 消融前的方块状态
     * @property newState 消融后的方块状态（可修改）
     */
    class Pre(
    ...
    companion object {
        /**
         * 方块消融前触发，返回事件对象（可读取修改后的 newState），返回 null 表示事件被取消
         */
